            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        ...
                        <Link
                            href={`/admin/reports/generate?eventId=${id}`}
                            className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-blue-500/20 text-blue-400 text-sm font-medium hover:bg-blue-500/30 transition-colors border border-blue-500/30"
                        >
